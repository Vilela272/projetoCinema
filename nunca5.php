...
$sql = "INSERT INTO dados5 (Rg, Nome, Pipoca, Refrigerante , Reservas) VALUES ('$Rg','$Nome', '$Pipoca', '$Refrigerante' , '$Reservas') ";
mysqli_query($strcon,$sql) or die("O assento não está disponível!!" );
mysqli_close($strcon);
echo "Cadastrado com sucesso!";
echo "<br><a href='consulta5.php'><input type='button' value='Consultar dados'></a>";
